---
title: Syscoin Core 0.13.2
id: en-release-0.13.2
name: release-0.13.2
permalink: /en/releases/0.13.2/
excerpt: Syscoin Core version 0.13.2 is now available
release: [0, 13, 2, 0]
date: 2017-01-03

# https://raw.githubusercontent.com/syscoin/syscoin/v0.13.2/doc/release-notes.md
---
...
Syscoin Core version 0.13.2 is now available from:
  ...
  <https://syscoincore.org/bin/syscoin-core-0.13.2/>
...
Microsoft ended support for Windows XP on [April 8th, 2014](https://www.microsoft.com/en-us/WindowsForBusiness/end-of-xp-support), an OS initially released in 2001. This means that not even critical security updates will be released anymore. Without security updates, using a syscoin wallet on a XP machine is irresponsible at least.

In addition to that, with 0.12.x there have been varied reports of Syscoin Core randomly crashing on Windows XP. It is [not clear](https://github.com/syscoin/syscoin/issues/7681#issuecomment-217439891) what the source of these crashes is, but it is likely that upstream libraries such as Qt are no longer being tested on XP.
...
- #8932 `106da69` Allow syscoin-tx to create v2 transactions (btcdrak)
