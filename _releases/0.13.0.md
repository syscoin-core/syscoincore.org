---
title: Syscoin Core 0.13.0
id: en-release-0.13.0
name: release-0.13.0
permalink: /en/releases/0.13.0/
excerpt: Syscoin Core version 0.13.0 is now available
release: [0, 13, 0, 0]
date: 2016-08-23
...
Syscoin Core version 0.13.0 is now available from:
  ...
  <https://syscoincore.org/bin/syscoin-core-0.13.0/>
...
Original announced on the [syscoin-core-dev](https://lists.linuxfoundation.org/pipermail/syscoin-core-dev/2016-August/000018.html) mailing list.
...
- `syscoin-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries for the most
  common 32-bit ARM architecture.
- `syscoin-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries for the most
