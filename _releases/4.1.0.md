---
title: Syscoin Core 4.1.0
id: en-release-4.1.0
name: release-4.1.0
permalink: /en/releases/4.1.0/
excerpt: Syscoin Core version 4.1.0 is now available
date: 2020-01-01
...
Syscoin Core version 4.1.0 is now available from:

  <https://syscoincore.org/bin/syscoin-core-4.1.0/>
...
From 4.1.0 onwards, macOS <10.10 is no longer supported. 0.17.0 is
...
- In 0.18.0, a `./configure` flag was introduced to allow disabling BIP70 support in the GUI (support was enabled by default). In 4.1.0, this flag is now __disabled__ by default. If you want to compile Syscoin Core with BIP70 support in the GUI, you can pass `--enable-bip70` to `./configure`. (#15584)
...
- #16882 Re-generate translations before 4.1.0 (MarcoFalke)
...
- #17014 Consolidate release notes before 4.1.0 (move-only) (MarcoFalke)
