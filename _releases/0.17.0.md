...
excerpt: Syscoin Core version 0.17.0 is now available
date: 2018-10-03
...
- The new RPC `scantxoutset` can be used to scan the UTXO set for entries
  ...
  reference documentation](https://github.com/syscoin/syscoin/tree/0.17/doc/descriptors.md) for more details. This call
