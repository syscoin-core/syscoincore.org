...
（这是一个由segwit实现的功能；Syscoin Core 0.13.1中不包括。）
...
Satoshi Nakamoto的[原始比特币文件][original Syscoin paper]描述了一种允许新启动的全节点跳过下载和验证来自受大量工作证明保护的历史块的一些数据的方法。
...
其功能冻结时间[计划](https://github.com/syscoin/syscoin/issues/8719) 为2017年1月中旬，并在所有测试完成后发布（通常需要一个多月，
以便留给每个人足够的测试时间）。

如果您有兴趣为比特币核心做贡献，请参阅我们的[贡献页面](/en/contribute) 和文档[如何向比特币核心贡献代码](/en/faq/contributing-code/)。
如果您不知道从哪里开始或有任何其他问题，请访问我们的[IRC](https://en.syscoin.it/wiki/IRC_channels)
