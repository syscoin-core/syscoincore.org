---
title: Syscoin Core 0.15.0.1 リリース
...
excerpt: >
  Syscoin Core 0.15.0.1 がリリースされ、0.15.0にアップグレードする際にクラッシュを引き起こすマイナーなバグが修正されました。
---
{% include toc.html %}
{% include references.md %}

Syscoin Core 0.15.0.1 がリリースされ、0.15.0にアップグレード後、GUIがクラッシュする可能性がある
...
[ファイルディレクトリ]: https://syscoincore.org/bin/syscoin-core-0.15.0.1/
