---
title: Syscoin Core 0.17.1
id: ja-release-0.17.1
name: release-0.17.1
permalink: /ja/releases/0.17.1/
excerpt: Syscoin Coreバージョン 0.17.1 が利用可能になりました
type: releases
layout: page
lang: ja
...
Syscoin Core バージョン0.17.1は以下から入手可能です。
...
syscoinが`-deprecatedrpc=accounts`の設定で構成されている場合、label/account/dummy引数を
