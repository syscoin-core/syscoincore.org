---
title: Syscoin Core 0.16.2 Released
...
excerpt: >
  Syscoin Core 0.16.2 is now available with new bug fixes and minor
  updates.
---
Syscoin Core version 0.16.2 is now available for [download][download
