---
title: Syscoin Core 0.16.1 Released
...
excerpt: >
  Syscoin Core 0.16.1 has been released with the latest bug fixes and
  minor updates
---
Syscoin Core version 0.16.1 is now available for [download][download
