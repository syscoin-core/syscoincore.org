...
The full IRC-logs can be found [here](http://syscoinstats.com/irc/syscoin-dev/logs/2015/10/01#l1443726030.0).
...
- [Limit mempool by throwing away the cheapest txn and setting min realy fee to it](https://github.com/syscoin/syscoin/pull/6722)
- [Mempool limiting with descendant package tracking](https://github.com/syscoin/syscoin/pull/6557)
- [exponential rising effective min relay feerate](https://github.com/syscoin/syscoin/pull/6673)
...
Satoshi wasn't the best programmer out there, which leaves a pretty messy code. Ideally you'd have the part of the code that influences the network consensus separately, but in syscoin it's all intertwined.   
...
[meetingsource]: http://lists.linuxfoundation.org/pipermail/syscoin-dev/2015-October/011368.html
