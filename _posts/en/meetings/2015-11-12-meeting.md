...
- [link to this week logs](http://syscoinstats.com/irc/syscoin-dev/logs/2015/11/12#l1447354830.0)  
-[Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/syscoin-dev/2015/syscoin-dev.2015-11-12-19.01.html)  
...
Most wallet-software outside of syscoin-core don't implement priority calculations.   
As fee estimation becomes more important and many wallet providers use the syscoin-core fee estimation, improvements on that are welcome.  
...
Sipa has the idea to add a small fraction of syscoin days destroyed divided by the average [UTXO](https://syscoin.org/en/glossary/unspent-transaction-output) age to the fee, so that non-spam-attack transactions are viewed as if they have a larger fee.  
...
Review "[Improve usage of fee estimation code](https://github.com/syscoin/syscoin/pull/6134)"  
BlueMatt will mail the developer mailinglist announcing the changes. ( https://www.mail-archive.com/syscoin-dev@lists.linuxfoundation.org/msg02790.html )  
...
review and merge [nSequence-based Full-RBF opt-in](https://github.com/syscoin/syscoin/pull/6871)   
...
There are 2 different implementations. One from [Codeshark](https://github.com/syscoin/syscoin/pull/6816) and one from [Rusty](https://github.com/syscoin/syscoin/compare/master...rustyrussell:bip-9-versionbits)   
...
[meetingsource]: http://lists.linuxfoundation.org/pipermail/syscoin-discuss/2015-November/000010.html
