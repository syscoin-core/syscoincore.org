...
- [Link to this week logs](https://botbot.me/freenode/syscoin-core-dev/2017-03-30/?msg=83238145&page=2)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/syscoin-core-dev/2017/syscoin-core-dev.2017-03-30-19.01.html)
 
---

## Notes / short topics

- BlueMatt notes 2 out of 6 of last weeks [blocked and review-needed PRs](/en/meetings/2017/03/23/#blocked-and-review-needed-prs) got merged, which can be better. Wumpus created a [high-priority for review](https://github.com/syscoin/syscoin/projects/8) github project page for the PRs that are mentioned to have priority in the meetings.
- There have been 11 merges tagged [0.14.1](https://github.com/syscoin/syscoin/pulls?q=is%3Aopen+is%3Apr+milestone%3A0.14.1) and 3 open PRs. Once those are in 0.14.1 should be good to go.
...
Jonasschnelli has a build server with a nice web UI which does gitian builds every day at [https://syscoin.jonasschnelli.ch/](https://syscoin.jonasschnelli.ch/).
...
[#10026]: https://github.com/syscoin/syscoin/issues/10026
[#10114]: https://github.com/syscoin/syscoin/pull/10114
[#10072]: https://github.com/syscoin/syscoin/pull/10072
[#9792]: https://github.com/syscoin/syscoin/pull/9792
[#9424]: https://github.com/syscoin/syscoin/pull/9424
[#10123]: https://github.com/syscoin/syscoin/pull/10123
