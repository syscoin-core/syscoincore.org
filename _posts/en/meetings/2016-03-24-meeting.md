...
- [Link to this week logs](http://syscoinstats.com/irc/syscoin-core-dev/logs/2016/03/24#l1458846025.0)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/syscoin-core-dev/2016/syscoin-core-dev.2016-03-24-19.00.html)
...
- Cfields is working on an overhaul of the network stack of syscoin core. This means a lot of movement of code, but it will make it easier to add additional features. He has a working full-featured [branch](https://github.com/theuni/syscoin/tree/net-refactor8) and he expects he'll be looking for concept reviews next week. Wumpus and sipa note he got their concept ACK at the Boston meeting.
...
As described in the [software life cycle][] document Syscoin Core developers aim to maintain the latest and previous major release, which currently are 0.12 and 0.11. Individual developers might choose to update previous versions, however this is not a policy rule.
...
jonasschnelli   sipa: code: https://github.com/theuni/syscoin/tree/net-refactor8   
...
[#7047]: https://github.com/syscoin/syscoin/pull/7047
...
[#7689]: https://github.com/syscoin/syscoin/pull/7689
