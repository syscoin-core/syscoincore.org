...
- [Link to this week logs](https://botbot.me/freenode/syscoin-core-dev/2016-12-22/?msg=78334610&page=2)
...
- Syscoin Core 0.13.2 Release Candidate 1 is [available](https://syscoin.org/bin/syscoin-core-0.13.2/test.rc1/) for testing.
...
- It would be nice to get some BIP comments posted now that [BIP2][] is active. The idea behind it being to provide users with a central location to differentiate between inadvisable and recommended BIPs. More info on format and procedure can be found in the ['BIP comments'-section](https://github.com/syscoin/bips/blob/master/bip-0002.mediawiki#BIP_comments).
...
Codeshark started working on a new message type for filtered blocks that includes the path to coinbase and a partial merkle tree for the witnesses. In addition, rather than sending all the transactions as separate messages, it includes them in the same structure. He started working on this code [here](https://github.com/syscoin/syscoin/compare/master...CodeShark:WitnessMerkleBlock2).
...
[#9298]: https://github.com/syscoin/syscoin/pull/9298
[#8755]: https://github.com/syscoin/syscoin/pull/8755
[#8654]: https://github.com/syscoin/syscoin/pull/8654
[#9289]: https://github.com/syscoin/syscoin/pull/9289
[#9375]: https://github.com/syscoin/syscoin/pull/9375
[#7533]: https://github.com/syscoin/syscoin/pull/7533
[#9138]: https://github.com/syscoin/syscoin/pull/9138
[#8776]: https://github.com/syscoin/syscoin/pull/8776
