...
- [Link to this week logs](http://syscoinstats.com/irc/syscoin-core-dev/logs/2016/03/31#l1459450785.0)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/syscoin-core-dev/2016/syscoin-core-dev.2016-03-31-18.59.html)
...
Update for network-stack refactors: cfields pushed an up-to-date version to his [net-refactor10 branch](https://github.com/theuni/syscoin/tree/net-refactor10) which is ready for testing and review. It still needs a bunch of unit tests for which cfields is building a framework for as well as documentation.
...
- code changes can be viewed [here](https://github.com/sipa/syscoin/compare/segwit-base...sipa:segwit)
...
As described in the [software life cycle][] document Syscoin Core developers aim to maintain the latest and previous major release, which currently are 0.12 and 0.11.
...
Some of the messages based on heuristics, such as the "abnormally high number of blocks" one seem to appear a lot despite there being no real issue: https://www.reddit.com/r/Syscoin/comments/3ydwg2/warning_abnormally_high_number_of_blocks/
...
Another issue is that some of the warnings don't go away when the (temporary) problem goes away, the only way to turn them off is to restart syscoind.
...
[#7543]: https://github.com/syscoin/syscoin/pull/7543
[#7716]: https://github.com/syscoin/syscoin/pull/7716
