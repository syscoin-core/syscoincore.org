...
- [link to this week logs](http://syscoinstats.com/irc/syscoin-dev/logs/2015/10/22#l1445540405.0)  
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/syscoin-dev/2015/syscoin-dev.2015-10-22-19.05.html)
...
[BIP 9](https://github.com/syscoin/bips/blob/master/bip-0009.mediawiki) Versionbits [PR #6816](https://github.com/syscoin/syscoin/pull/6816) is ready for implementation and needs more reviews.

A 3 month moderation period on the syscoin-dev mailinglist has started, as well as a new list syscoin-discuss. more details: http://lists.linuxfoundation.org/pipermail/syscoin-dev/2015-October/011591.html

"syscoin.org had incorrect release notes for 0.11.1. It's corrected now. They had posted the release notes for the initial RC and not updated them. Process wise it would be good to watch out for that in the future."
...
To stop this from happening devs created a mechanism to reject and/or remove transactions from the mempool. This [mempool limiting](https://github.com/syscoin/syscoin/pull/6722) got merged this week.  
...
Testing shows there's a discrepancy between the configured mempool limit and the actual memory usage. This is caused by the amount of [UTXO](https://syscoin.org/en/glossary/unspent-transaction-output) data when processing transactions.   
...
Something TheBlueMatt [is working on](https://github.com/syscoin/syscoin/pull/6872)
...
LevelDB is the database system currently used in syscoin. Since this is not being maintained for some time devs are looking for replacements.

### meeting comments

jgarzik worked on a [patch for SQLite](https://github.com/syscoin/syscoin/pull/6873)  
...
CLTV stands for CheckLockTimeVerify, [BIP65](https://github.com/syscoin/syscoin/pull/6351) Commonly reffered to as: How you thought nLockTime worked before you actually tried to use it. 
...
review [BIP-113: Mempool-only median time-past as endpoint for lock-time calculations](https://github.com/syscoin/syscoin/pull/6566)
...
[meetingsource]: http://lists.linuxfoundation.org/pipermail/syscoin-discuss/2015-October/000003.html
