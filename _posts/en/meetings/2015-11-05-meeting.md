...
- [link to this week logs](http://syscoinstats.com/irc/syscoin-dev/logs/2015/11/05#l1446750061.0)  
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/syscoin-dev/2015/syscoin-dev.2015-11-05-19.01.html)  
...
Closing date for proposals for the scaling syscoin workshop is the 9th.

Check to see if there are any other commits for the 0.11.2 RC. As soon as [6948](https://github.com/syscoin/syscoin/pull/6948) and [6825](https://github.com/syscoin/syscoin/pull/6825) are merged it seems good to go.  
...
0.11.2 RC1 has been released as of today: https://syscoin.org/bin/syscoin-core-0.11.2/test/
...
Because of time-constrains [opt-in replace-by-fee](https://github.com/syscoin/syscoin/pull/6871) has been deferred to next weeks meeting, but most people seem to want it in 0.12. sdaftuar makes a note that we need to make clear to users what they need to do if they don't want to accept opt-in transactions.  
...
Syscoin-core 0.12 is scheduled for release December 1st.

### meeting comments

Everybody likes to include [secp256k1](https://github.com/syscoin/syscoin/pull/6954) ASAP, as it has a very large performance increase.   
Some people would like to include the [sigcache pull-request](https://github.com/syscoin/syscoin/pull/6918), [BIP30](https://github.com/syscoin/syscoin/commit/a206b0ea12eb4606b93323268fc81a4f1f952531), [modifyNewCoins](https://github.com/syscoin/syscoin/pull/6932) and a [createNewBlock rewrite](https://github.com/syscoin/syscoin/pull/6898) if it's ready.   
Wumpus advises against merging last-minute performance improvements for 0.12.  

### meeting conclusion

Mentioned pull-requests should be reviewed, prioritizing [CreateNewBlock](https://github.com/syscoin/syscoin/pull/6898)  
...
There's a [pull-request](https://github.com/syscoin/syscoin/pull/6357) available that optimizes the current transaction priority, thereby avoiding the political debate that goes with changing the definition of transaction priority.  
Luke-jr thinks the old policy should remain possible.
 
### meeting conclusion

Check to see if [PR #6357](https://github.com/syscoin/syscoin/pull/6357) is safe and efficient enough.
...
This attack is described [here](https://syscointalk.org/index.php?topic=1166928.0).
...
With the recent malleability attacks, anyone who made transactions going multiple layers deep would've already encountered huge problems doing this (beautifully explained in [let's talk syscoin #258](https://letstalksyscoin.com/blog/post/lets-talk-syscoin-258-liquidity-and-malleability) from 13:50 onwards)   
...
Possible sources of these chains: a service paying the fees on other transactions (child-pays-for-parent), an iOS wallet that gladly spends unconfirmed change. A business confirms they use child-pays-for-parent when they receive syscoins from an unspent chain.  
...
Merge ["Policy: Lower default limits for tx chains"](https://github.com/syscoin/syscoin/pull/6771)  
...
[meetingsource]: http://lists.linuxfoundation.org/pipermail/syscoin-discuss/2015-November/000008.html
