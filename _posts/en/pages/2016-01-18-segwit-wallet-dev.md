...
* A segwit-compatible wallet MUST also support the new serialization format, as <code>nVersion|marker|flag|txins|txouts|witness|nLockTime</code>
    ...
    * The <code>witness</code> is a serialization of all witness data of the transaction.
        ...
        * Each witness field starts with a <code>compactSize</code> [integer](https://syscoin.org/en/developer-reference#compactsize-unsigned-integers) to indicate the number of stack items for the corresponding <code>txin</code>. It is then followed by witness stack item(s) for the corresponding <code>txin</code>, if any. 
...
* For spending of P2SH-P2WPKH:
    ...
    * There is a new signature generation algorithm described in [BIP143][] for segwit scripts. Developers should follow the instructions carefully, and make use of the P2SH-P2WPKH example in [BIP143](https://github.com/syscoin/bips/blob/master/bip-0143.mediawiki#P2SHP2WPKH) to make sure they are able to reproduce the <code>sighash</code>.
    ...
    * [Example](http://n.syscoin.ninja/checktx?txid=8139979112e894a14f8370438a471d23984061ff83a9eba0bc7a34433327ec21)
...
* Restrictions on the script
    ...
    * If OP_IF or OP_NOTIF is used, it argument MUST be either an empty vector (for false) or <code>0x01</code> (for true). Use of other value may lead to permanent fund loss. ([BIP draft](https://lists.linuxfoundation.org/pipermail/syscoin-dev/2016-August/013014.html))
...
* For spending of P2SH-P2WSH:
    ...
    * [Example](http://n.syscoin.ninja/checktx?txid=954f43dbb30ad8024981c07d1f5eb6c9fd461e2cf1760dd1283f052af746fc88)
...
* [Example](http://n.syscoin.ninja/checktx?txid=d869f854e1f8788bcff294cc83b280942a8c728de71eb709a2c29d10bfe21b7c)
...
* [Example](http://n.syscoin.ninja/checktx?txid=78457666f82c28aa37b74b506745a7c7684dc7842a52a457b09f09446721e11c)
...
* [Examples of different witness transaction types and transaction validity checking tool](http://n.syscoin.ninja/checktx)
* [BIP141][]
* [BIP143][]
* [BIP173][]
* [Script tests](https://github.com/syscoin/syscoin/blob/master/src/test/data/script_tests.json)
* [Valid transaction tests](https://github.com/syscoin/syscoin/blob/master/src/test/data/tx_valid.json)
* [Invalid transaction tests](https://github.com/syscoin/syscoin/blob/master/src/test/data/tx_invalid.json)
