---
title: How to contribute code to Syscoin Core
...
The project coding conventions in the [developer notes](https://github.com/syscoin/syscoin/blob/master/doc/developer-notes.md) must be adhered to.
